        ...
        <div id="content">
            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Purchasing History</h1>
                    <p></p>
                    <!-- Content Row -->
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-right">
                                	<form method="post" action="<?=base_url()?>purchasings/grns_search/1" 
                                                    	...
                                                    	<tbody>
                                                  		<? 	foreach ($grn_items as $data){?>
                                                            ...
                                                            <tr>
                                                              ...
                                                              <td class="text-center"><?=$data->original_quantity?></td>
